...
namespace OSKB
{
    ...
    public partial class OnscreenKeyboard : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        private float oskb_fCursorFlashDelay = 0.25f;
        ...
        private float fKeyPressCheckDelay = 0.3f;
        ...
        private string oskb_PromptText = "Please enter your player name:";
        ...
        protected override void LoadGraphicsContent(bool loadAllContent)
        {
            ...
            if (loadAllContent)
            {
                ...
                {
                    sImageNames[0] = @"content\onscreenkeyboard\800\800_keyboard_1";
                    sImageNames[1] = @"content\onscreenkeyboard\800\800_keyboard_2";
                    sImageNames[2] = @"content\onscreenkeyboard\800\800_keyboard_3";
                    oskb_DestRect = new Rectangle(0, 0, 800, 600);
                    oskb_EntryHilightX = 123;
                    oskb_EntryHilightY = 205;
                    oskb_EntryStartX = 15;
                    oskb_EntryStartY = 108;
                    oskb_PromptX = 10;
                    oskb_PromptY = 71;
                    oskb_PlayerIconX = 745;
                    oskb_PlayerIconY = 67;
                }
        ...
        protected void Update_TextEntry(GamePadState GPad, KeyboardState KBoard, GameTime gameTime)
        {
            ...
            if ((GPad.ThumbSticks.Left.X < -0.55f) || (GPad.DPad.Left == ButtonState.Pressed))
            {
                oskb_EntryHilightPos -= 1;
                fTotalElapsedTime = 0.0f;
            }

            if ((GPad.ThumbSticks.Left.X > 0.55f) || (GPad.DPad.Right == ButtonState.Pressed))
            {
                oskb_EntryHilightPos += 1;
                fTotalElapsedTime = 0.0f;
            }
            ...
            if (GPad.ThumbSticks.Left.Y < -0.55f || (GPad.DPad.Down == ButtonState.Pressed))
            {
            ...
            if (GPad.ThumbSticks.Left.Y > 0.55f || (GPad.DPad.Up == ButtonState.Pressed))
            {
                oskb_EntryHilightPos -= 10;
                fTotalElapsedTime = 0.0f;
            }
